export default {
  ...
  'browser-download': {
    ...
    'user-agent-placeholder': 'Leave empty for default',
    'authorization': 'Authorization',
    'authorization-placeholder': 'username:password',
    'referer': 'Referer',
    'referer-placeholder': 'Referer URL',
    'cookie': 'Cookie',
    'cookie-placeholder': 'Leave empty for default',
    'proxy': 'Proxy',
    'proxy-none': 'No proxy',
    'proxy-global': 'Use global proxy',
    'proxy-custom': 'Custom proxy',
    'proxy-server': 'Proxy Server',
    'custom-proxy': 'Custom Proxy',
    'custom-proxy-placeholder': 'http://127.0.0.1:7890',
  },
}
